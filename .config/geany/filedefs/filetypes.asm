...
EX_11_WD=%d
EX_12_LB=Create MC-10 WAV file and launch MAME (local)
EX_12_CM=$HOME/scripts/makeWAV-mc10.sh mc10 n
EX_12_WD=%d
EX_13_LB=Create MC-10 WAV file and launch XRoar (local)
EX_13_CM=$HOME/scripts/makeWAV-mc10-XRoar.sh mc10
EX_13_WD=%d
EX_14_LB=Create MC-10 WAV file and launch MAME (pyDW)
