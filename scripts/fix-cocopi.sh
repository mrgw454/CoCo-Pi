...
if grep -q "$fix" $file; then
        ...
        echo Applying fix $fix...
        echo
        tar xvf $HOME/update/cmoc-0.1.84-CoCoPi.tar.gz -C /
        cd $HOME/source/cmoc-0.1.84
	sudo make install
...
if grep -q "$fix" $file; then
        ...
        echo Applying fix $fix...
        echo
        tar xvf $HOME/update/cmoc-0.1.85-CoCoPi.tar.gz -C /
        cd $HOME/source/cmoc-0.1.85
		sudo make install
...
if grep -q "$fix" $file; then
    ...
    echo Applying fix $fix...
    echo
    tar xzf /home/pi/update/ugBasic-git-20230906-CoCoPi.tar.gz -C /
...
if grep -q "$fix" $file; then
    ...
    echo Applying fix $fix...
    echo
    tar xzf /home/pi/update/ugBasic-git-20230911-CoCoPi.tar.gz -C /
...
if grep -q "$fix" $file; then
    ...
    echo Applying fix $fix...
    echo
    tar xzf /home/pi/update/ugBasic-git-20231006-CoCoPi.tar.gz -C /
...
if grep -q "$fix" $file; then
    ...
    echo Applying fix $fix...
    echo
    tar xzf /home/pi/update/ugBasic-git-20231015-CoCoPi.tar.gz -C /

        cd $HOME/source/ugbasic/ugbc/exe
        sudo cp ugbc.coco /usr/local/bin
        sudo cp ugbc.coco3 /usr/local/bin
        sudo cp ugbc.d64 /usr/local/bin
        sudo cp ugbc.d32 /usr/local/bin
