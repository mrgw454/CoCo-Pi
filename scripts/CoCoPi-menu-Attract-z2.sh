...
while opt=$(zenity --width=640 --height=480 --title="$title" --window-icon="/home/pi/Pictures/CoCo-Pi.png" --text="$prompt" --list  --column=""  "${options[@]}"); do
    ...
    "${options[3]}" ) $HOME/scripts/attract-mode-random-coco2-xroar.sh /media/share1/carts;;
    "${options[4]}" ) $HOME/scripts/attract-mode-random-dragon.sh;;
    "${options[5]}" ) $HOME/scripts/attract-mode-dragon64h-ssfm.sh;;
    "${options[6]}" ) $HOME/scripts/attract-mode-dragon-random-xroar.sh;;
    "${options[7]}" ) $HOME/scripts/attract-mode-random-mc-10-128k.sh /media/share1/JIMG;;
    "${options[8]}" ) $HOME/scripts/attract-mode-random-coco3.sh /media/share1/RonD/BMP;;
    "${options[9]}" ) $HOME/scripts/attract-mode-random-ORCH90.sh /media/share1/SDC/MUSIC/MODS;;
    "${options[10]}" ) $HOME/scripts/demo-mode.sh;;
    "${options[11]}" ) $HOME/scripts/attract-mode-dkong.sh;;
