...
$HOME/pyDriveWire/pyDwCli http://localhost:6800 dw disk insert 0 $HOME/source/eou_ide/build/6309/63IDE.dsk
...
xroar -c $HOME/.xroar/xroar.conf -default-machine coco3 -ram 2048K -machine-cpu 6309 -tv-input rgb -machine-cart ide -load-hd0 $HOME/source/eou_ide/build/6309/63IDE.ide -type '\r\DOS\r' $XROARPARMS
