...
# press [F10] in mame to toggle "-nothrottle" option on/off
...
mame coco3h -ramsize 512k -cart /media/share1/roms/yados.rom -ext fdcv11 -hard1 /media/share1/DW4/CCFLASH/CCFLASH.DSK -autoboot_delay 4 -autoboot_command 'DRIVE I 1,6,3\nDRIVE U 0\nDRIVE M 0,1,0,0,0\nDRIVE M 1,0,0\nDRIVE M 2,0,1\nDRIVE M 3,0,2\nWIDTH80\nDRIVE I:DRIVE M\n' $MAMEPARMS
