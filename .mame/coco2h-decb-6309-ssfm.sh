...
then
	...
	mame coco2h -ram 64k -ext multi -ext:multi:slot3 ssfm -flop1 "$floppy" $MAMEPARMS
    else
	...
	mame coco2h -ram 64k -ext multi -ext:multi:slot3 ssfm -flop1 "$1" -flop2 "$2" -screen0 lefttoright $MAMEPARMS
