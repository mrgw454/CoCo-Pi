    ...
    "6" "Edit      WiFi configuration" \
    "7" "Edit      pyDriveWire configuration" \
    ...
    case $RETVAL in
        ...
        6) editWiFi.sh && CoCoPi-menu-Utilities-Administration.sh;;
        7) editpyDWconfig.sh && CoCoPi-menu-Utilities-Administration.sh;;
