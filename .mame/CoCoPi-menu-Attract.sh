    ...
    "6" "Dragon 64 MAME  Attract Mode Disks (SSFM)" \
    "7" "Dragon 32 XRoar Attract Mode Carts (random)" \
    "8" "MC-10 MAME      Attract Mode Jim Gerrie (random)" \
    "9" "Coco 3 MAME     Image Slideshow (random)" \
    "10" "Coco 3 MAME     CoCoTracker Demo (random)" \
    "11" "Coco Demo       Simultaneous Sessions" \
    "12" "MAME            Play Donkey Kong Hacks" \
    ...
    case $RETVAL in
        ...
        6) attract-mode-dragon64h-ssfm.sh && CoCoPi-menu-Attract.sh;;
        7) attract-mode-dragon-random-xroar.sh && CoCoPi-menu-Attract.sh;;
        8) attract-mode-random-mc-10-128k.sh /media/share1/JIMG && CoCoPi-menu-Attract.sh;;
       ...
       11) demo-mode.sh && CoCoPi-menu-Attract.sh;;
       12) attract-mode-dkong.sh && CoCoPi-menu-Attract.sh;;
       13) menu;;
        *) echo "Quitting...";;
    esac
